...
export const Sidebar = () => {
  ...
  return (
    <div className="w-[120px] bg-stone-800 text-white flex flex-col gap-10 items-center p-5 fixed h-screen lg:w-[250px]">
      ...
      <nav className="w-full space-y-5 flex-1">
        {dashboardLinks.map((link) => (
          <NavLink
            ...
            to={link.href}
            className={({ isActive }) =>
              `flex items-center justify-center gap-3 pl-0 py-3 transition-all duration-3000 rounder-md
      ...
      <button
        className="bg-red-500 w-full py-[10] rounded-md flex items-center justify-center gap-2 font-semibold text-sm hover:underline"
