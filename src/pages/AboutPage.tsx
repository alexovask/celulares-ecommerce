  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex flex-col gap-4 tracking-tighter leading-7 text-sm font-medium text-slate-800">
        <p>
          PhoneStore es una tienda en línea que se dedica a la venta de
        ...
        <p>
          En PhoneStore podrás encontrar una amplia variedad de celulares de las
        ...
        <h2 className="text-3xl font-semibold tracking-tighh mt-8 mb-4">
          ¡No esperes más y compra tu celular en PhoneStore!
        </h2>

        <p>
          Para más información, no dudes en ponerte en contacto con nosotros, a
          través de nuestro correo electrónico:
          <a href="mailto:correo@PhoneStore.com">correo@PhoneStore.com</a> o
          llamado al <a href="tel:333333333">3333333333</a>
        </p>
      </div>
    </div>
  );
