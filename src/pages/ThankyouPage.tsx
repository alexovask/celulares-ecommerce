...
export const ThankyouPage = () => {
  ...
  const { isLoading: isLoadingSesion } = useUser();
  ...
  if (isLoading || !data || isLoadingSesion) return <Loader />;
    ...
    <div className="flex flex-col h-screen">
      ...
      <main className="container flex-1 flex flex-col items-center gap-10">
        ...
        <div className="border border-slate-200 w-full md:w-[600px] p-5 rounded-md space-y-3">
          ...
          <p className="text-sm">
            Gracias por realizar tu compra en PhoneStore. Para realizar la
            transferencia te compartimos los siguientes datos
          </p>

          <div className="space-y-0.5 text-sm">
            <p>BANCO PICHINCHA</p>
            <p>Razón Social: PhoneStore</p>
          ...
          <p className="text-sm">
            ...
            ventas@PhoneStore.com para procesarla y hacerte la entrega de tu
